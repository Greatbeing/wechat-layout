---
name: "wechat-layout"
description: "微信公众号图文排版设计器，提供11种预设风格，生成可直接粘贴到公众号编辑器的内联CSS HTML。/ WeChat article layout designer with 11 preset styles, outputs inline-CSS HTML pasteable into WeChat editor."
---

# 微信公众号排版设计器

设计精美的微信公众号图文排版，提供 11 种预设视觉风格。所有输出使用**内联 CSS**，可直接复制粘贴到微信公众号编辑器。
...
| 11 | 高端知识 | 金棕 `#c4a35a` + 米白 `#f5f5f0`，胶囊标签 | 知识付费、人物图谱、深度内容 |
...
Style 11 (高端知识): primary=#c4a35a, secondary=#8b6914, accent=#f5f5f0, text=#333
```
...
| 16 | 人物卡片 | 圆形头像 + 姓名标签 + 胶囊身份标签 + 简介 + 社交账号，支持左右交替布局 |
| 17 | 波浪装饰线 | 金色/主题色艺术分隔线，含菱形等装饰图案（用 SVG 或图片实现） |
| 18 | 关键词高亮 | 主题色 + 加粗标记重点词汇，替代整句变色 |
